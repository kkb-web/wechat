...
<script>
    ...
    import {cashierSearch} from "../../api/api"
    ...
    export default {
        ...
        methods :{
            ...
            getOrderStatus(){
                ...
                cashierSearch(sendData).then(res=>{
                    console.log(res.data.data,'urlGetOrderInfo');
                    //判断订单状态
                    if(res.data.code === 0){
                        this.$router.push({path: routeUrl() +  'paying', query: {orderId: this.orderNo}});
                    }else{
